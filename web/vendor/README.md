...
0.7.0 source release. `web/requirements.txt` fetches this wheel from the
`v0.7.0` GitHub tag with a SHA-256 pin for the Studio server functions,
including its `sarvam` and `mongodb` extras.
