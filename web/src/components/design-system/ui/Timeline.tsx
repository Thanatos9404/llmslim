...
export function Timeline({ className }: { className?: string }) {
  const milestones: Milestone[] = [
    ...
    {
      version: "v0.2.0",
      title: "Priority Protection Foundations",
      status: "completed",
      features: [
        "Priority-aware instruction and code signals",
    ...
    },
    {
      ...
      features: [
        ...
        "ContextRole priority boundary for RAG, tool, and assistant content",
        "Inline-code, CJK, and token-counter correctness fixes",
      ],
    },
    {
      version: "v0.4.0",
