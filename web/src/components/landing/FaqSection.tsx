...
export function FaqSection() {
  const faqs: FaqItem[] = [
    { question: "Does LLMSlim prevent prompt injection?", answer: "No. v0.3.1 mitigates compression-induced instruction elevation by preventing untrusted RAG, tool, and assistant content from gaining protected priority through imperative or safety-critical wording. Applications still need defense in depth." },
    ...
    { question: "What performance should I expect?", answer: "Measure your workload. Compression ratio and latency depend on input, hardware, tokenizer availability, and strategy; v0.3.1 does not promise a universal latency target." },
    { question: "Are npm, Rust, or WASM runtimes available?", answer: "No. v0.3.1 is a Python release; those runtimes are not published product capabilities." },
  ];
