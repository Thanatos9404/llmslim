...
export function FeatureGridSection() {
  return <section id="features" className="py-20 sm:py-28 px-4 sm:px-8 max-w-7xl mx-auto space-y-12">
    <div className="text-center space-y-4 max-w-3xl mx-auto"><span className="badge-scientific text-emerald-400 text-xs">v0.4.0 Python release</span><h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight">Compression with <span className="text-gradient-emerald">clear trust boundaries</span></h2><p className="text-slate-400 text-base leading-relaxed">LLMSlim ranks sentences locally and makes provenance explicit where protected priority matters.</p></div>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <FeatureCard title="Provenance-aware priority" subtitle="RAG, tool, and assistant content cannot become Tier 4 or must_keep merely from imperative wording. This mitigates compression-induced instruction elevation; it is not complete prompt-injection prevention." badge="v0.4.0 security" glowColor="emerald" icon={<ShieldCheck className="w-5 h-5 text-emerald-400" />} />
      ...
      <FeatureCard title="Contract-safe tool APIs" subtitle="v0.4.0 adds stable tool-schema canonicalization, fingerprints, and contract verification. Tool retrieval remains an explicit research-only API." badge="Release gate" glowColor="emerald" icon={<DollarSign className="w-5 h-5 text-emerald-400" />} />
