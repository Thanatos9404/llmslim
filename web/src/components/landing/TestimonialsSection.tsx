...
export function TestimonialsSection() {
  return <section className="py-20 sm:py-28 px-4 sm:px-8 max-w-7xl mx-auto space-y-8">
    ...
    <Card glowColor="emerald" className="p-8 max-w-3xl mx-auto"><Quote className="w-6 h-6 text-emerald-400 mb-4" /><p className="text-slate-300 leading-relaxed">The v0.3.1 release gate records 432 passing tests, 92.57% branch coverage, Ruff success, and a benchmark runner that reports actual pytest outcomes.</p></Card>
  </section>;
}
